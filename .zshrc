...
## ディレクトリ名だけで cd
setopt auto_cd
## 指定したディレクトリがない場合，cd_pathから移動先を検索する
cdpath=(~)
...
if [ -x /usr/local/bin/brew ]; then
	...
	fpath=($BREW_PREFIX/share/zsh/functions $BREW_PREFIX/share/zsh-completions $fpath)
fi

if [ -e $BREW_PREFIX/etc/autojump.zsh ]; then
	alias j='autojump'
	. $BREW_PREFIX/etc/autojump.zsh
fi
#
# 補完
...
# homebrew caskで，/Applicationsにシンボリックリンクを作成する
#export HOMEBREW_CASK_OPTS="--appdir=/Applications"
# brew-fileで生成するbrewfileのpath
export HOMEBREW_BREWFILE="/Users/kunimune/.brewfile/Brewfile"

# brewコマンドを使うと自動的にBrewfileを更新する
